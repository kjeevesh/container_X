...
class MC_MM_P003(object):
    ...
    def l1_mcmmp003(self):
        ...
        if env_var == 'DEV' :
            ...
            file_path1 = '/tmp/app/Flask_api/dummydata/mc_mm_p003/eban.json'
            file_path2 = '/tmp/app/Flask_api/dummydata/mc_mm_p003/ekpo.json'
            file_path3 = '/tmp/app/Flask_api/dummydata/mc_mm_p003/ekko.json'        
