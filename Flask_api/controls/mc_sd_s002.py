...
class MC_SD_S002(object):
    ...
    def l1_mcsds002(self):
        ...
        if env_var == 'DEV' :
            ...
            file_path1 = '/tmp/app/Flask_api/dummydata/mc_sd_s002/sd_002_bkpf.json'
            file_path2 = '/tmp/app/Flask_api/dummydata/mc_sd_s002/sd_002_bseg.json'
            file_path3 = '/tmp/app/Flask_api/dummydata/mc_sd_s002/sd_002_bsad.json'
