...
class ITSEC001(object):
    ...
    def l1_itsec001(self):
        ...
        if env_var == 'DEV' :
            ...
            file_path1 = '/tmp/app/Flask_api/dummydata/itsec001/usr02.json'
            file_path2 = '/tmp/app/Flask_api/dummydata/itsec001/ust04.json'
            file_path3 = '/tmp/app/Flask_api/dummydata/itsec001/user_addr.json'
