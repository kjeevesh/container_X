...
class MC_MM_P006(object):
    ...
    def l1_mcmmp006(self):
        ...
        if env_var == 'DEV' :
            ...
            file_path1 = '/tmp/app/Flask_api/dummydata/mc_mm_p006/rbkp.json'
            file_path2 = '/tmp/app/Flask_api/dummydata/mc_mm_p006/rseg.json'
            file_path3 = '/tmp/app/Flask_api/dummydata/mc_mm_p006/ekbe.json'
            file_path4 = '/tmp/app/Flask_api/dummydata/mc_mm_p006/mkpf.json'
    ...
    def l2_create_json_ticket(self, exception_data):
        ...
        json_skeleton = self.utils.read_json_file('/tmp/app/config/itsec001/itsec001_schema.json')            
