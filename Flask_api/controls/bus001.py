...
class BussCtrl_001(object):
    ...
    def __init__(self) -> None:
        ...
        creds_fileName = "/tmp/app/config/sap_cred.json"
        mongodb_cred = "/tmp/app/config/mongodb_creds.json"
    ...
    def l1_date_filtering(self): 
        ...
        if env_var == 'DEV' :
            ...
            file_path1 = '/tmp/app/Flask_api/dummydata/bus001/erev.json'
            file_path2 = '/tmp/app/Flask_api/dummydata/bus001/ekko.json'
            file_path3 = '/tmp/app/Flask_api/dummydata/bus001/ekpo.json'
            file_path4 = '/tmp/app/Flask_api/dummydata/bus001/lfa1.json'
            file_path5 = '/tmp/app/Flask_api/dummydata/bus001/ekkn.json'
    ...
    def l2_create_json_ticket(self, exception_data):
        ...
        json_skeleton = self.utils.read_json_file('/tmp/app/config/itsm_schema.json')          
